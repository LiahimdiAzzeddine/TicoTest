            ...
            <div className="flex flex-col md:flex-row items-center justify-start md:justify-between gap-y-8 md:gap-x-10 w-full max-w-6xl">
                ...
                <div className="hidden md:flex justify-center">
                    <img
                        ...
                        className="w-52 md:w-96 lg:w-[25rem] 2xl:w-[26rem]"
                    />
                </div>
                    ...
                    <div className="flex flex-col justify-start items-start gap-8 md:gap-10">
                        ...
                        <div className="flex flex-col gap-4">
                            <p className="text-lg text-[#0a548d] ArchivoLight leading-tight text-start">
                                Il pleut des scandales alimentaires, comment
                                trouver des produits sains et durables dans ce
                                contexte ?
                            </p>
                            <p className="text-lg text-[#0a548d] ArchivoLight leading-tight text-start">
                                Un atelier team building ludique et immersif
                                donnant les clés pour mieux comprendre les
                                enjeux de notre alimentation et mieux choisir en
                                magasin sans se prendre la tête.
                            </p>
                            <p className="text-lg text-[#0a548d] ArchivoLight leading-tight text-start">
                                Entre collaborateurs ou lors d’un évènement,
                                organisez ce moment de partage autour d’un sujet
                                qui nous concerne tous : notre alimentation !
                            </p>
                            <div
                            ...
                            <p className="text-lg text-[#0a548d] ArchivoLight leading-tight text-start">
                                Réservation possible en participant à notre{" "}
                                <a
